...
test_that("workflow can be run: simple", {
  ...
  expect_match(status$start_time, "^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}")
...
test_that("workflow can be run: dependencies", {
  ...
  expect_match(status_1$start_time,
  ...
  expect_match(status_2$start_time,
               "^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}")
  ...
  expect_match(status_3$start_time,
               "^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}")
...
test_that("can get status of a worfklow", {
  ...
  expect_match(status$reports[[1]]$start_time,
               "^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}")
  ...
  expect_match(status$reports[[2]]$start_time,
               "^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}")
  ...
  expect_match(status$reports[[3]]$start_time,
               "^\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}")
